 ...
 * @author Cuzki
 */
public class SexScaleData extends ChartData{
    ...
    public String getCoordinateLabel(int indexX) {
        ...
        String percent=(totle==0?"0":new DecimalFormat(".00").format(value*100/totle));
        return  ("<font color=\"#000000\">"+name+"</font><br>"+"<font color=\"#000000\">"+"("+percent+"%)"+"</font>");
    }
}
